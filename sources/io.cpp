...
void saveRes(const std::vector<Flower>& source, long size) {
    ...
    string base = "/Users/ekaterinagridneva/Desktop/hse/mp/sort-benchmark/sorted_data/" + size_str;
    ...
    ofstream fout("/Users/ekaterinagridneva/Desktop/hse/mp/sort-benchmark/info_time.txt", ofstream::app);
    if (!fout.is_open()) {
