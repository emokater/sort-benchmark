...
\item 
vector$<$ \mbox{\hyperlink{class_flower}{Flower}} $>$ \mbox{\hyperlink{io_8h_a290bc2a300c281d6ff0a846b014af8b0}{parser\+CSV}} (string filename)
...
void \mbox{\hyperlink{io_8h_a3ef0f516e9350331943a8a85181912b8}{save\+Res}} (const std\+::vector$<$ \mbox{\hyperlink{class_flower}{Flower}} $>$ \&source, long size)
...
\Hypertarget{io_8h_a290bc2a300c281d6ff0a846b014af8b0}\index{io.h@{io.h}!parserCSV@{parserCSV}}
\index{parserCSV@{parserCSV}!io.h@{io.h}}
\doxysubsubsection{\texorpdfstring{parserCSV()}{parserCSV()}}
{\footnotesize\ttfamily \label{io_8h_a290bc2a300c281d6ff0a846b014af8b0} 
...
Internally, the parser locates the first three commas to extract the name, color and smell fields. ~\newline
 ...
 If the file contains no data lines (only a header or is empty), an empty vector is returned. \Hypertarget{io_8h_a3ef0f516e9350331943a8a85181912b8}\index{io.h@{io.h}!saveRes@{saveRes}}
\index{saveRes@{saveRes}!io.h@{io.h}}
\doxysubsubsection{\texorpdfstring{saveRes()}{saveRes()}}
{\footnotesize\ttfamily \label{io_8h_a3ef0f516e9350331943a8a85181912b8} 
